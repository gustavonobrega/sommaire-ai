...
export function LoadingSkeleton() {
  return (
    <Card
      className="relative px-2 h-[500px] w-[600px] max-w-lg mx-auto overflow-hidden 
    ...
    >
      <div className="absolute top-0 left-0 right-0 z-20 bg-background/80 backdrop-blur-xs pt-4 pb-2 border-b border-rose-500/10">
        <div className="px-4 flex gap-1.5">
          {[1, 2, 3].map((_, index) => (
            <div
              key={index}
              className="h-1.5 flex-1 rounded-full bg-rose-500/20 overflow-hidden"
            >
              <div
                className={cn(
      ...
      <div className="flex flex-col mb-6 sticky top-6 py-2 bg-background/80 backdrop-blur-xs z-10">
